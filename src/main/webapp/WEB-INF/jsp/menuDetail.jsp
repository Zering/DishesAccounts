			...
			<div class="panel-body">
				<form action="/DishesAccounts/insertMenu" class="form-horizontal" role="form" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" name="materials[0].materialName" type="text" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="材料2">材料2</label>
						<div class="col-sm-6">
							<input class="form-control" name="materials[1].materialName" type="text" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-1 control-label" for="材料3">材料3</label>
						<div class="col-sm-6">
							<input class="form-control" name="materials[2].materialName" type="text" />
						</div>
					</div>
						...
						<div id="moreMaterials" class="accordion-body collapse">
							<div class="accordion-inner">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input class="form-control" name="materials[3].materialName" type="text" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-1 control-label" for="材料6">材料5</label>
									<div class="col-sm-6">
										<input class="form-control" name="materials[4].materialName" type="text" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-1 control-label" for="材料6">材料6</label>
									<div class="col-sm-6">
										<input class="form-control" name="materials[5].materialName" type="text" />
									</div>
								</div>
							</div>
						</div>
